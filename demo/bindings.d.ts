...
export type Async = AsyncAll | AsyncNone | AsyncOnly;
export interface AsyncAll {
  tag: "all",
}
export interface AsyncNone {
  tag: "none",
}
export interface AsyncOnly {
  tag: "only",
  val: string[],
}
export enum Lang {
...
export class Config {
  ...
  setWasmtimeAsync(async: Async): void;
